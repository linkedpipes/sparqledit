...
export class ParserVisualiser extends React.Component<ParserVisualiserProps, any> {
    ...
    table(itemSet: ItemSet) {
        return this.props.parserVisualiser.table[itemSet.Id].map((action, index) => (
            <ListItem key={index}>
    ...
    render() {
        ...
        return (
            <Card>
                ...
                <CardText>
                    {
                        this.props.parserVisualiser.itemSets.map((itemSet, index) => this.renderItemSet(itemSet, index))
                    }
                </CardText>
            </Card>
        );
