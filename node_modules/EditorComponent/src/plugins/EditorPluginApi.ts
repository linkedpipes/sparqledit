...
export interface IEditorPluginApi {
    ...
    getSparqlLanguageService(): SparqlLanguageService;
}
...
export class EditorPluginApi implements IEditorPluginApi {
    ...
    private sparqlLanguageServerService: SparqlLanguageService;
    ...
    constructor(
        ...
        this.sparqlLanguageServerService = new SparqlLanguageService(sparqlEditorSettings);
    }
    ...
    getSparqlLanguageService() {
        return this.sparqlLanguageServerService;
    }
}