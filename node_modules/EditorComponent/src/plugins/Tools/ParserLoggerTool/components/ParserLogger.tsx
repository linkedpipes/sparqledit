...
import { ParserResult, ParserResultStore, ParsingService } from "../ParsingService";
...
export class ParserLogger extends React.Component<ParserLoggerProps, any> {
    ...
    runParserClick() {
        var parserService = new ParsingService();
    ...
    render() {
        ...
        return (<div>
            ...
            {res.parserOutput == null  ? null : this.parserOutputCard()}
            {res.lexerOutput == null ? null : this.lexerOutputCard()}
            <ParserLoggerStates parserResultStore={this.parserResultStore} />
        </div>);
    }
}
