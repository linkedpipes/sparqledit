    ...
    registerIntelisenseChange(
        ...
        monacoEditor.onDidChangeCursorPosition((e) => {
            ...
            if (autocompleteAdvices == null) {
                ...
                var ontologyHierarchy = sparqlLanguageServer.ontologyHierarchy;
                origintelisenseResult.conceptNodeInput = createConceptNodeInput(ontologyHierarchy, autocompleteAdvices.map(x => x.concept));
            }
        });
    }
