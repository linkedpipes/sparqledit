...
export class NodeApi {
    ...
    insertPropertyIntoEditor(propertyName: string): void {
        ...
        var insertedText = propertyName.match(/^http:\/\//) ? "<" + propertyName + ">" : propertyName;
        var newEditorValue = editorValue.substr(0, editorCursorIndex) + insertedText + editorValue.substr(editorCursorIndex);
