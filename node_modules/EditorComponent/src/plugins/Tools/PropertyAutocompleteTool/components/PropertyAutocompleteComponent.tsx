...
export class PropertyAutocompleteComponent extends React.Component<PropertyAutocompleteComponentProps, any> {
    ...
    refreshAutocomplete() {
        ...
        this.intelisenseResult = (new QueryAdviceInferencer(this.ontologyHiearchy)).providePropertyAutocompletion(editorContentAndPosition.content, editorContentAndPosition.position);
    }
