...
import { SparqlLanguageServer, QueryInferencer, OntologyConcept, OntologyProperty, OntologyHiearchy } from "SparqlAutocompletion";
...
export class PropertyAutocompleteComponent extends React.Component<PropertyAutocompleteComponentProps, any> {
    ...
    refreshAutocomplete() {
        ...
        this.intelisenseResult = (new QueryInferencer(this.ontologyHiearchy)).providePropertyAutocompletion(editorContentAndPosition.content, editorContentAndPosition.position);
    }
