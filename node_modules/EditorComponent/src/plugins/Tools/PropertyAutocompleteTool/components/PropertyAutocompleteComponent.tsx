        ...
        return (
            <li key={classIndex}>
                <ExpandableList
                    ...
                    titleClassName="expandClass"
                    title={ontologyClass.getText(this.ontologyClassTextFormatter)}>

                    {this.ontologyHiearchy.ontologyAssertions.findPropertiesByDomain(ontologyClass).map((property, propertyIndex) =>
                        <ExpandableListItem key={propertyIndex}>{property.name}</ExpandableListItem>)
                    }
                </ExpandableList>
            </li>
        );
