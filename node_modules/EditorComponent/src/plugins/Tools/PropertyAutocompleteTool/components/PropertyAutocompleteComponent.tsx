...
export class PropertyAutocompleteComponent extends React.Component<PropertyAutocompleteComponentProps, any> {
    ...
    refreshAutocomplete() {
        ...
        this.intelisenseResult = (new QueryAdviceInferencer("Restricted", this.ontologyHiearchy)).providePropertyAutocompletion(editorContentAndPosition.content, editorContentAndPosition.position);
    }
