...
export class PropertyAutocompleteComponent extends React.Component<PropertyAutocompleteComponentProps, any> {
    ...
    refreshAutocomplete() {
        ...
        var propertiesAdvices = (new QueryAdviceInferencer("Restricted", this.ontologyHierarchy)).providePropertyAutocompletion(editorContentAndPosition.content, editorContentAndPosition.position);
