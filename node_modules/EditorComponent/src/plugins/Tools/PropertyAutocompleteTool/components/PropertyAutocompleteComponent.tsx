...
import { SparqlLanguageServer, QueryAdviceInferencer, OntologyConcept, OntologyProperty, OntologyHiearchy } from "SparqlAutocompletion";
...
export class PropertyAutocompleteComponent extends React.Component<PropertyAutocompleteComponentProps, any> {
    ...
    refreshAutocomplete() {
        ...
        var propertiesAdvices = (new QueryAdviceInferencer("Restricted", this.ontologyHiearchy)).providePropertyAutocompletion(editorContentAndPosition.content, editorContentAndPosition.position);
        this.intelisenseResult = (propertiesAdvices as any).getData();
    }
