...
import { ParserVisualisingService, IParserVisualisingServiceResult, Action, GotoAction, ShiftAction, ReduceAction } from "../ParserVisualisingService";
import { Card, CardHeader, CardText, List, ListItem, Paper } from "material-ui";
import { ItemSet, ERSParserDebuggable } from "ERSParser";

@observer
export class ParserVisualiser extends React.Component<any, any> {
