import { SparqlLanguageServer, Serializer, TurtleGraphWrapper, OntologyHiearchyBuilder, OntologyAssertionsBuilder, SparqlAutocompleteProvider, SparqlSignatureHelpProvider } from "SparqlAutocompletion";
...
export class SparqlLanguageServerService {
    ...
    constructor() {
        ...
        // this.getOntologyFromServer(source, (ontologyCon) => {
        ...
        //     var ontologyHiearchy = ontologyHiearchyBuilder.createOntologyHiearchy(ontologyAssertions.ontologyAssertions);
        ...
        this.getOntologyFromServer('./ontologies/precomputednow.json', (ontologyContent) => {
            ...
            var ontologyAssertions = serializer.deserializeOntologyAssertions(ontologyContent);
