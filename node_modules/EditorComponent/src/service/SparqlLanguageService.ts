...
export class SparqlLanguageService {
    ...
    constructor() {
        ...
        this.getOntologyFromServer(source, (ontologyContent) => {
            var forbiddenSources = ["http://purl.obolibrary.org/obo/obi.owl", "http://vivoweb.org/ontology/core"];
            this.sparqlLanguageServer = sparqlLanguageServerFactory.createFromTurtle(ontologyContent, forbiddenSources);
        });
