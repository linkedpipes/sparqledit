...
import { ERSParser, ItemSet } from "ERSParser";
...
export class ParserVisualisingService {
    ...
    run(parser: ERSParser): IParserVisualisingServiceResult {
    ...
    createInverseSymbolTable(parser: ERSParser) {
    ...
    mapTableToActions(parser: ERSParser) {
