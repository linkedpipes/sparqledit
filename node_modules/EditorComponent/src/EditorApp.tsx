import { PluginManagerFactory } from './factory/PluginManagerFactory';
...
import { EditorSettingsFactory } from "./factory/EditorSettingsFactory";
...
export class EditorApp extends React.Component<any, any> {
    ...
    setMonacoEditor(monacoEditor: monaco.editor.IStandaloneCodeEditor) {
        ...
        this.pluginManager.initPlugins(editorPluginApi);
    }
