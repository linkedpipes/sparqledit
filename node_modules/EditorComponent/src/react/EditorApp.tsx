...
import { ParserVisualiser } from "EditorComponent/src/react/components/ParserVisualiser";
...
export class EditorApp extends React.Component<any, any> {
    ...
    private init() {
        ...
        this.parserVisualisingServiceResult = parserVisualisingService.run(new ERSParser());
