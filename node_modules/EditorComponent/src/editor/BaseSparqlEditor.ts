...
export abstract class BaseSparqlEditor {
    private editorAppComponent: EditorApp;
    ...
    public init() {
        ...
        this.editorAppComponent = <EditorApp>ReactDOM.render(renderElement, this.container);
    }

    public changeOntologySourceUrl(ontologySourceUrl: string, ontologySourceType?: "custom" | "raw" | "precomputed") {
        this.editorAppComponent.changeOntologySourceUrl(ontologySourceUrl, ontologySourceType);
    }
