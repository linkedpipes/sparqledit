...
GraphPatternNotTriplesError
    : 'OPTIONAL' error 
    {
        logParserError('OPTIONAL', getEnd(@1), getEnd(@2));
        $$ = null;
    }
    | 'GRAPH' error 
    {
        logParserError('GRAPH', getEnd(@1), getEnd(@2));
        $$ = null;
    }
    | 'SERVICE' error 
    {
        logParserError('SERVICE', getEnd(@1), getEnd(@2));
        $$ = null;
    }
    | 'FILTER' error 
    {
        logParserError('filter', getEnd(@1), getEnd(@2));
        $$ = null;
    }
    | 'BIND' error 
    {
        logParserError('BIND', getEnd(@1), getEnd(@2));
        $$ = null;
    }
    | 'VALUES' error 
    {
        logParserError('VALUES', getEnd(@1), getEnd(@2));
        $$ = null;
    }
    ;
