%{
  ...
  */
  ...
  function logParserError(type, startTokenRange, endTokenRange){
         
      var parserError = {
            type: type,
            message: 'something is wrong ' + type,
            options: {
                startTokenRange:startTokenRange,
                endTokenRange:endTokenRange
            },
            range:{
                first_line: startTokenRange.last_line,
                first_column: startTokenRange.last_column,
                last_line: endTokenRange.last_line,
                last_column: endTokenRange.last_column,
            } 
      };
...
TriplesSameSubjectError
    ...
    | error { 
        $$ = [];
        logParserError("TriplesSameSubject", @-0, @1);
    }
    ;
TriplesSameSubject
...
VerbObjectListError
    ...
    { 
        $$ = [];
        logParserError("VerbObjectList", @-0, @1);
    }
    ;
VerbObjectList
