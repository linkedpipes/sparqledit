var RecoverableParserError = new require('./errors/RecoverableParserError').RecoverableParserError;
var HaltingParserError = new require('./errors/HaltingParserError').HaltingParserError;
...
PreParserContext.prototype.getErrors = function () {
    ...
    if (this.isQuotesOpen) {
        haltingError = new RecoverableParserError("missingCloseQuotes", null, null);
    ...
    this.removeCloseParenthesisFrom.forEach(function (offset) {
        var error = new RecoverableParserError("extraClosedParenthesis", null, null);
        error.options = {
            offset: offset
        }
        errors.push(error);
    ...
    if (this.openParenthesisCount > 0) {
        var error = new RecoverableParserError("missingOpenParenthesis", null, null);
        error.options = {
...
PreParserContext.prototype.getFixedQuery = function () {
    ...
    for (var i = 0; i < removeCloseParenthesisFrom.length; i++) {
