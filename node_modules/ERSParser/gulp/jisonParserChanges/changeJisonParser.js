...
function changeJisonParser(definitionsType) {
    var changesDefinitionFile = __dirname + '/definitions/' + definitionsType + 'changesDefinition.json';
...
module.exports = changeJisonParser;