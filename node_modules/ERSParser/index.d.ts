...
export declare interface ParserRange {
    first_line: number;
    first_column: number;
    last_line: number;
    last_column: number;
...
export declare interface RecoverableParserError {
    type: string;
    startTokenRange: ParserRange;
    endTokenRange: ParserRange;
}

export declare interface HaltingParserError {
    message: string;
    startTokenRange: ParserRange;
    endTokenRange: ParserRange;
}
...
export declare interface IParserResult {
    query: any;
    recoverableErrors: RecoverableParserError[];
    haltingError: HaltingParserError;
}