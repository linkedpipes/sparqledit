...
function createOntologyHierarchyFromContent(fileContent: string) {
    var ontologyAssertionsResult = ontologyAssertionsBuilder.buildOntologyAsertions(new TurtleGraphWrapper(fileContent));
    var ontologyHierarchy = ontologyHiarchyBuilder.createOntologyHierarchy(ontologyAssertionsResult.ontologyAssertions);
...
describe('OntologyAutocompleteSubProvider', () => {
    it('should do simple autocomplettion', () => {
        ...
        var ontologyHierachy = createOntologyHierarchyFromContent(hiearchySchemaContent);
