...
describe("RestrictedPropertySelector", () => {
    it("should sort 1. testcase by topological order.", () => {
        ...
        var propertySelector = new RestrictedPropertySelector(ontologyHierarchy);
        var propertiesAdvices = propertySelector.getPropertiesFor(nc(0));
        chai.expect(propertiesAdvices.orderConcepts).to.deep.equal([no([0]), no([4, 3, 2, 1])]);
    });
    ...
    it("should sort 2. testcase by topological order.", () => {
        ...
        var propertySelector = new RestrictedPropertySelector(ontologyHierarchy);
        var propertiesAdvices = propertySelector.getPropertiesFor(nc(0));
        chai.expect(propertiesAdvices.orderConcepts).to.deep.equal([no([0]), no([1])]);
    });
    ...
    it("should sort 4. testcase by topological order.", () => {
        ...
        var propertySelector = new RestrictedPropertySelector(ontologyHierarchy);
        var propertiesAdvices = propertySelector.getPropertiesFor(nc(0));
        chai.expect(propertiesAdvices.orderConcepts).to.deep.equal([no([0]), no([2]), no([4]), no([7])]);
    });
    ...
    it("should sort 5. testcase by topological order.", () => {
        ...
        var propertySelector = new RestrictedPropertySelector(ontologyHierarchy);
        var propertiesAdvices = propertySelector.getPropertiesFor(nc(0));
        chai.expect(propertiesAdvices.orderConcepts).to.deep.equal([no([0]), no([6, 3, 2]), no([4, 5]), no([7])]);
    });
    ...
    it("should sort 6. testcase by topological order.", () => {
        ...
        var propertySelector = new RestrictedPropertySelector(ontologyHierarchy);
        var propertiesAdvices = propertySelector.getPropertiesFor(nc(0));
        chai.expect(propertiesAdvices.orderConcepts).to.deep.equal([no([0]), no([3, 2, 1])]);
    });
    ...
    it("should not fail on non-existing ontology concept.", () => {
        ...
        var propertySelector = new RestrictedPropertySelector(ontologyHierarchy);
        var propertiesAdvices = propertySelector.getPropertiesFor(nc(3));
        var properties = propertiesAdvices.getAllPoperties();
        var propertiesByChunk = propertiesAdvices.getPropertiesByChunk();
        chai.expect(propertiesAdvices.orderConcepts).to.deep.equal([]);
        chai.expect(properties).to.deep.equal([]);
        chai.expect(propertiesByChunk).to.deep.equal([]);
    });
});