import { RestrictedParentOntologyClassTracker } from "../../../src/Autocompletition/Inference/ParentOntologyClassTracker";
...
describe("Property advice helper with restricted tracker", () => {
    var tracker = new RestrictedParentOntologyClassTracker();
    ...
    it("should not fail on non-existing ontology concept.", () => {
        ...
        var orderConcepts = createPropertyAdviceForOntologyClass(tracker, ontologyAssertions, nc(3));
