...
import { NodeType, Block, OntologyAutocompleteSubProvider } from '../src/Autocompletition/SubProviders/OntologyAutocompleteSubProvider';
...
describe('AutocompleteProvider', () => {
    it('should do simple autocomplettion', () => {
        ...
        var autocompleteProvider = new OntologyAutocompleteSubProvider(ontologyHierachy);
