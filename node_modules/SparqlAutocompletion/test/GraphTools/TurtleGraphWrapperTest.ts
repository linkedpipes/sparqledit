...
describe("TurtleGraphWrapper", () => {
    describe("should match triples", () => {
        var turtleFile = require("raw-loader!../TestData/GraphTools/matchTest.ttl");
    ...
    describe("shoud work with blank nodes", () => {
        var turtleFile = require("raw-loader!../TestData/GraphTools/blankNodeTest.ttl");
    ...
    describe("shoud work with collections", () => {
        var turtleFile = require("raw-loader!../TestData/GraphTools/collectionTest.ttl");
        ...
        it("should extract empty collection", () => {
            ...
            chai.expect(result.getTriplesCount()).equal(1);
            chai.expect(result.triples[0].object.nominalValue).equal("http://www.w3.org/1999/02/22-rdf-syntax-ns#nil");
        });        
    });
});