...
describe("OntologyAssertions", () => {
    ...
    var c5 = new AtomicClass("http://example.org/c5");
    var c6 = new AtomicClass("http://example.org/c6");
    var c7 = new AtomicClass("http://example.org/c7");
    ...
    it("should correctly work with findSuperSetClasses", () => {
        var ontologyAssertions = new OntologyAssertions();
        ontologyAssertions.addDomain(p1, c1);
        ontologyAssertions.addSubclassEdge(c3, c4);
        ontologyAssertions.addSubclassEdge(c3, c5);
        ontologyAssertions.addSubclassEdge(c6, c7);

        var r1 = ontologyAssertions.findSuperSetClasses(c1);
        chai.expect(r1).to.deep.equal([]);

        var r2 = ontologyAssertions.findSuperSetClasses(c2);
        chai.expect(r2).to.deep.equal([]);

        var r3 = ontologyAssertions.findSuperSetClasses(c3);
        chai.expect(r3).to.deep.equal([c4, c5]);

        var r4 = ontologyAssertions.findSuperSetClasses(c5);
        chai.expect(r4).to.deep.equal([]);

        var r5 = ontologyAssertions.findSuperSetClasses(c6);
        chai.expect(r5).to.deep.equal([c7]);
    });
