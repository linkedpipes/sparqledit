...
import { OntologyHierarchy } from '../../../src/Ontology/OntologyHierarchy';
...
describe('OntologyHierarchyBuilder', () => {
    ...
    it('should create ontology hiearchy which tests strongly connected components.', () => {
        ...
        var ontologyHiarchy = ontologyHierarchyBuilder.createOntologyHierarchy(ontologyAssertions);
    ...
    it('shold not do this', () => {
        function conceptMetric(concept: OntologyConcept, ontologyHiarchy: OntologyHierarchy) {
    ...
    it('autocomplete order', () => {
        ...
        var propsAlg = new FullPropertySelector(dbpediaOntologyAssertions);

        var result = propsAlg.getPropertiesFor(new AtomicClass(testIri));
        var ne = '';
    });
