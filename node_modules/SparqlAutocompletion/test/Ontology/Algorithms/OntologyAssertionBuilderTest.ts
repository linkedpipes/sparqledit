...
describe('OntologyAssertionBuilder', () => {
    it('should load assertions.', () => {
        var fileContent = require("raw-loader!../../TestData/Ontology/Algorithms/ontologyAssertionsTest.owl.ttl");
        var graph = new TurtleGraphWrapper(fileContent);
        var ontologyAssertions = (new OntologyAssertionsBuilder()).buildOntologyAsertions(graph).ontologyAssertions;
