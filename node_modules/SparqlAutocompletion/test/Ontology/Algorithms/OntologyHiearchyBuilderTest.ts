...
function createOntologyAssertionsFrom(fileContent: string) {
    ...
    return ontologyAssertionsResult.ontologyAssertions;
}
...
describe('OntologyHiearchyBuilder', () => {
    it('should create ontology hiearchy which tests strongly connected components.', () => {
        ...
        var ontologyAssertions = createOntologyAssertionsFrom(require('raw-loader!./resources/stronglyConnectedComponents.owl.ttl'));
    ...
    it('shold not do this', () => {
        ...
        var ontologyAssertions = createOntologyAssertionsFrom(require("raw-loader!./../../ontologies/dbpedia.ttl"));
    ...
    it('should create large ontology hiarchy', () => {
        ...
        var ontologyFileContent = fs.readFileSync('../../ontologies/dbpedia.ttl').toString();
        var ontologyAssertions = createOntologyAssertionsFrom(ontologyFileContent);
        var ontologyHiearchyBuilder = new OntologyHiearchyBuilder();
        var ontologyHiarchy = ontologyHiearchyBuilder.createOntologyHiearchy(ontologyAssertions);
    });
