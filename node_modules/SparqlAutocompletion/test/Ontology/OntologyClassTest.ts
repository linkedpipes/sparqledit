...
describe('OntologyClass', () => {
    describe('OntologyClass equal method', () => {
        ...
        it('should work for ComplementClass.', () => {
            var ac1 = new AtomicClass("http://example.org/test1");
            var ac2 = new AtomicClass("http://example.org/test2");
            var cc1 = new ComplementClass(ac1);
            var cc2 = new ComplementClass(ac1);
            var cc3 = new ComplementClass(ac2);

            chai.expect(cc1.equal(cc2)).to.be.true;
            chai.expect(cc2.equal(cc3)).to.be.false;
        });
    });
});
