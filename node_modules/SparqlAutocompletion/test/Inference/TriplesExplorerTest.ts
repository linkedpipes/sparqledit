...
function findTriples(queryText: string) {
...
describe("TriplesExplorer", () => {
    it("should pass test1.sparql", () => {
        var triples = findTriples(require("raw-loader!../TestData/Inference/TriplesExplorer/test1.sparql"));
    ...
    it("should pass test2.sparql", () => {
        var triples = findTriples(require("raw-loader!../TestData/Inference/TriplesExplorer/test2.sparql"));
        chai.expect(triples).not.null;
        chai.expect(triples.length).equal(4);
    });

    it("should pass test3.sparql", () => {
        var triples = findTriples(require("raw-loader!../TestData/Inference/TriplesExplorer/test3.sparql"));
        chai.expect(triples).not.null;
        chai.expect(triples.length).equal(3);
    });

    it("should pass test4.sparql", () => {
        var triples = findTriples(require("raw-loader!../TestData/Inference/TriplesExplorer/test4.sparql"));
        chai.expect(triples).not.null;
        chai.expect(triples.length).equal(2);
    });

    it("should pass test5.sparql", () => {
        var triples = findTriples(require("raw-loader!../TestData/Inference/TriplesExplorer/test5.sparql"));
        chai.expect(triples).not.null;
        chai.expect(triples.length).equal(2);
    });
