import { OntologyHiearchy } from '../../src/Ontology/OntologyHierchy';
...
export function createOntologyAssertionsFromTurtle(fileContent: string) {
...
export function createOntologyFromTurtle(ontologyContent: string): OntologyHiearchy {
    var ontologyAssertions = createOntologyAssertionsFromTurtle(ontologyContent);
