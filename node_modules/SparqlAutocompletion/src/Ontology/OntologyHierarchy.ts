...
export class OntologyHierarchy {
    ...
    public addSubclassOfEdge(subsetClassIndex: number, superClassIndex: number) {
    ...
    public existSubclassOfEdge(subsetClassIndex: number, superClassIndex: number) {
        return this.subClassOfEdges.some((x) => x.subsetClassIndex == subsetClassIndex && x.superClassIndex == superClassIndex);
    }

    public existsSubclassOfEdgeConcept(subsetClassConcept: OntologyConcept, superClassConcept: OntologyConcept) {
