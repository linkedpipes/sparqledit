...
import { OntologyHierarchy, OntologyConcept } from '../OntologyHierarchy';
...
export class OntologyHierarchyBuilder {
    private stronglyConnectedComponentAlgorithm = new SccLibAlgorithmWrapper();

    public createOntologyHierarchy(ontologyAssertions: OntologyAssertions) {
