import { AtomicClass, IOntologyClass, UnknownClass } from '../OntologyClass';
import { AlgorithmErrorLogger } from './Errors/AlgorithmErrors';
import { RdfIri } from '../../Utils/RdfIri';
import { RDFNodeType, IGraph } from '../../GraphTools/GraphInterfaces';
...
export class OntologyAssertionsBuilder {
    ...
    private buildOntologyAsertionsOnGraph(context: OntologyAssertionsBuilderContext): void {
        ...
        this.buildLabels(context.graph, context.ontologyAssertions);
        // Log errors
        ...
        context.algorithmErrorLogger.writeErrorToConsole();
    }

    private buildLabels(graph: IGraph, ontologyAssertions: OntologyAssertions) {
    ...
    public buildOntologyAsertionsMultipleGraphs(graphs: IGraph[]) {
        ...
        for (var graph of graphs) {
            this.buildOntologyAsertionsOnGraph({
                graph: graph,
                ontologyAssertions: ontologyAssertions,
                algorithmErrorLogger: algorithmErrorLogger
            });
