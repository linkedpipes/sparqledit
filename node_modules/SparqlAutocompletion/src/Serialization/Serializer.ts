...
import { OntologyLabelSerializer } from "./TypeSerializers/OntologyLabelSerializer";
...
export class Serializer {
    ...
    constructor() {
        ...
        this.registerTypeSerializer("OntologyLabel", new OntologyLabelSerializer());
    }
    ...
    serializeOntologyAssertions(ontologyAssertions: OntologyAssertions) {
        return this.serialize("OntologyAssertions", ontologyAssertions);
    }
