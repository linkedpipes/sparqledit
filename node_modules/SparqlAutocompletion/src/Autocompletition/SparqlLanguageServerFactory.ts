...
export class SparqlLanguageServerFactory {
     ...
     */
    public createFromEditorFormat(editorOntologyAssertions: string) {
        try {
        ...
        switch (editorFormat.type) {
            case "raw":
                ...
                return this.createFromTurtle(editorFormat.value, forbiddenSources);
            case "precomputed":
                return this.createFromSerializedOntologyAssertions(editorFormat.value);
            default:
