...
export class SparqlHoverProvider {
    ...
    constructor(private ontologyAssertions: OntologyAssertions, private languageTag: string) {
        this.queryInferencer = new QueryClassInferencer(this.ontologyAssertions);
    }
    ...
    provideHover(query: string, cursorOffset: number) {
        ...
        var assertions = this.ontologyAssertions;
