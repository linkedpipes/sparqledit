...
export class OntologyAutocompleteSubProvider implements AutocompleteSubProvider {
    ...
    constructor(private ontologyHiearchy: OntologyHiearchy, private sparqlLanguageServerSettings: SparqlLanguageServerSettings) {
        // empty
    }

    provideAutocompleteItems(context: AutocompleteContext): SparqlAutocompleteItem[] {
        var ontologyInferencer = new QueryAdviceInferencer(this.sparqlLanguageServerSettings.getPropertySelectorType(), this.ontologyHiearchy);
