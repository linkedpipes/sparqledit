...
import { OntologyConcept } from '../Ontology/OntologyHierarchy';
...
export class SparqlLanguageServer {
    ...
    constructor(private ontologyAssertions: OntologyAssertions, sparqlLanguageServerSettings: ISparqlLanguageServerSettings) {
        ...
        this.queryAdviceInferencer = new QueryAdviceInferencer(logger, ontologyAssertions, coealescedSparqlLanguageServerSettings.getPropertySelectorType());
    }
