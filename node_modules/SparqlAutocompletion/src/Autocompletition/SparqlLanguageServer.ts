...
export class SparqlLanguageServer {
    ...
    private createOntologyHiearchyFromFile() {
        ...
        var ontologyAssertionsResult = this.ontologyAssertionsBuilder.buildOntologyAsertionsMultipleGraphs(graphs);
        var ontologyHiearchy = this.ontologyHiarchyBuilder.createOntologyHiearchy(ontologyAssertionsResult.ontologyAssertions);
