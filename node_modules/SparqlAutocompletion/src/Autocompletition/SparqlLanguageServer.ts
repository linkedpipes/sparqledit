...
export class SparqlLanguageServer {
    ...
    constructor(private ontologyAssertions: OntologyAssertions, sparqlLanguageServerSettings: ISparqlLanguageServerSettings) {
        ...
        this._sparqlAutocompleteProvider = new SparqlAutocompleteProvider(this._ontologyHiearchy, coealescedSparqlLanguageServerSettings);
        this._sparqlSignatureHelpProvider = new SparqlSignatureHelpProvider(this._ontologyHiearchy, coealescedSparqlLanguageServerSettings);
        this._sparqlHoverProvider = new SparqlHoverProvider(this._ontologyHiearchy, this.defaultLanguageTag);
    }
