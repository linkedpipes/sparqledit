...
export class QueryAdviceInferencer {
    private getAllProps: IPropertySelector;
    ...
    constructor(propertySelectorType: "Restricted" | "Full", private ontologyHiearchy: OntologyHiearchy) {
        ...
        this.getAllProps = propertySelectorFactory.createPropertySelector("Full", ontologyHiearchy);
    ...
    getAdvicesForClass(ontologyClass: IOntologyClass, prefixes: { [key: string]: string }) {
        var computedProps = this.getAllProps.getPropertiesFor(ontologyClass);
