...
export class QueryAdviceInferencer {
    ...
    constructor(
        ...
        this.propertySelector = propertySelectorFactory.createPropertySelector(propertySelectorType, ontologyHierarchy);
    ...
    getAdvicesForVariable(
        ...
        var ontologyConcepts = this.propertySelector.getPropertiesFor(inferenceVariable.possibleClasses[0]);

        return new PropertyQueryAdvice(ontologyConcepts, this.ontologyHierarchy, prefixes);
    }
