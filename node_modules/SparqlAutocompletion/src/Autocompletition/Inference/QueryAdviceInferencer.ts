...
export class QueryAdviceInferencer {
    ...
    constructor(propertySelectorType: "Restricted" | "Full", private ontologyHierarchy: OntologyHierarchy) {
        ...
        this.classInferencer = new QueryClassInferencer(this.ontologyHierarchy);
    }
    ...
    getAdvicesForVariable(
        ...
        if (variableItem.subjectVariableName != null) {
            ...
            if (subjectVariableItem.possibleClasses.length > 0) {
                ...
                return new PropertyQueryAdvice(subjectVariableItem.possibleClasses, structuredAdvices);
            }
        }
        return null;
    }
    ...
    inferVariableAdvices(query: any, variableName: string): IQueryAdvice {
        ...
        var result = this.getAdvicesForVariable(context, variableItem, query.prefixes);
        return result;
    }
