...
export function createParentOntologyTrackerFromSettings(parentOntologyClassTracking: "Restricted" | "Full"): IParentOntologyClassTracker {
    switch (parentOntologyClassTracking) {
        case "Full":
