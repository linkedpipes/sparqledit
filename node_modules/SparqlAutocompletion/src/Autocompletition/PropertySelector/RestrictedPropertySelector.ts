import { PropertyForConceptProvider, IReachabeConceptResult } from './FullPropertySelector';
...
export class RestrictedPropertySelector {
    ...
    trackClassRecursive(context: NotAllContext) {
        ...
        for (var edgeNode of edgeNodes) {
            ...
            console.log(currentNodeClass.getText() + '->' + edgeNode.getText());
            if (!isEquivalentEdge &&
    ...
    doAlgorithm(ontologyClass: IOntologyClass) {
