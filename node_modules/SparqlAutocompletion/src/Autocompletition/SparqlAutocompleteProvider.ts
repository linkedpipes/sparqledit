...
export class SparqlAutocompleteProvider {
    ...
    constructor(private ontologyHierarchy: OntologyHierarchy, sparqlLanguageServerSettings: SparqlLanguageServerSettings) {
        this.subProviders = [
            new OntologyAutocompleteSubProvider(this.ontologyHierarchy, sparqlLanguageServerSettings),
