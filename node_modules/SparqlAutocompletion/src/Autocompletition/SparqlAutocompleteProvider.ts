...
export class SparqlAutocompleteProvider {
    ...
    constructor(
        ...
        sparqlLanguageServerSettings: SparqlLanguageServerSettings) {
        this.subProviders = [
            new OntologyAutocompleteSubProvider(logger, this.ontologyAssertions, sparqlLanguageServerSettings),
